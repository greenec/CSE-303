 ...
 *
 *   bash:> for i in `seq 12`; do ./select_client.exe -p [server port] -s
 *            [server name] -w $i & done
 *
 *   (Note: all of the above, from 'for' to 'done', should be on a single line
 *    in the terminal.)
 *
 *  If you look at the output of the server, you'll see interesting
 * interleavings among the clients' messages.
 */
